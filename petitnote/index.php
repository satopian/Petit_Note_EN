...
if(!isset($misskey_note_ver)||$misskey_note_ver<20260818){
...
if(!isset($clap_inc_ver)||$clap_inc_ver<20260823){
...
// テンポラリ
defined("TEMP_DIR") || define("TEMP_DIR","temp/");
// ログ
defined("LOG_DIR") || define("LOG_DIR","log/");
// 画像
defined("IMG_DIR") || define("IMG_DIR","src/");
// サムネイル
defined("THUMB_DIR") || define("THUMB_DIR","thumbnail/");
...
function res (): void {
	...
	//年齢確認が必要な設定の時は表示フラグがonの時にもOGP画像を非表示のままにする
